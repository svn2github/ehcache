 ...
 * @author cdennis
 */
public class DeleteAsyncOperationSerializationTest {
  
  private static final Comparator<DeleteAsyncOperation> COMPARATOR = new Comparator<DeleteAsyncOperation>() {
    @Override
    public int compare(DeleteAsyncOperation o1, DeleteAsyncOperation o2) {
  ...
  public void testBasic() throws IOException, ClassNotFoundException {
    validateSerializedForm(new DeleteAsyncOperation("foo", new Element("foo", "bar", 1L, 2L, 3L, 4L, 0L), 42L), COMPARATOR, "serializedforms/DeleteAsyncOperationSerializationTest.testBasic.ser");
  }
}
