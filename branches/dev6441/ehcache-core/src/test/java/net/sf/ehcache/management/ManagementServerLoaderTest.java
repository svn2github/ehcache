...
public class ManagementServerLoaderTest {
  ...
  public void testRegistrationLifecycle() throws Exception {
    ...
    try {
      ...
      assertThat(DummyManagementServerImpl.status, is(DummyManagementServerImpl.Status.STARTED));
      ...
      assertThat(DummyManagementServerImpl.status, is(DummyManagementServerImpl.Status.STOPPED));
    } finally {
