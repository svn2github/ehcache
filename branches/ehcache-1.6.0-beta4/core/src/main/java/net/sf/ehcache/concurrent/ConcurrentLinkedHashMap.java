...
import static net.sf.ehcache.concurrent.ConcurrentLinkedHashMap.Node.newElement;
import static net.sf.ehcache.concurrent.ConcurrentLinkedHashMap.Node.newSentinel;
