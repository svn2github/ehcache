...
public abstract class AbstractWebTest {
     ...
     * {@value}
     */
    public static final String TEST_SERVER_HOST = System.getProperty("test.server.host", "localhost");

    /**
     * {@value}
     */
    public static final int TEST_SERVER_PORT = Integer.parseInt(System.getProperty("test.server.port", "9090").trim());
    ...
    protected String buildUrl(String uri) {
        return "http://" + TEST_SERVER_HOST + ":" + TEST_SERVER_PORT + "/ehcache-web" + uri;
    }
