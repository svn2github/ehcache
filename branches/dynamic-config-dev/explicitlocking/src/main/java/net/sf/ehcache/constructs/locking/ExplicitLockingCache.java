...
public class ExplicitLockingCache implements Ehcache {
     ...
     *
     * @param statisticsAccuracy one of
     *                           {@link net.sf.ehcache.Statistics#STATISTICS_ACCURACY_BEST_EFFORT}
     *                           ,
     *                           {@link net.sf.ehcache.Statistics#STATISTICS_ACCURACY_GUARANTEED}
     *                           , {@link net.sf.ehcache.Statistics#STATISTICS_ACCURACY_NONE}
     ...
     * to call {@link #put}
     *
     * @throws LockTimeoutException if timeout millis is non zero and this method has been unable
     *                              to acquire a lock in that time
     * @throws RuntimeException     if thrown the lock will not released. Catch and call
     ...
     * @param doNotNotifyCacheReplicators whether the put is coming from a doNotNotifyCacheReplicators
     ...
     * exist
     *
     * @param element to add to the cache
