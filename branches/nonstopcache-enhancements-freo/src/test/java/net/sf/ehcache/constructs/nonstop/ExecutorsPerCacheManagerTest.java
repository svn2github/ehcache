...
public class ExecutorsPerCacheManagerTest extends TestCase {
    ...
    public void testExecutorsPerCacheManager() {
        CacheManager cacheManager1 = new CacheManager(getClass().getResourceAsStream("/basic-cache-test.xml"));
        Cache cache = cacheManager1.getCache("test");
        NonStopCache nonStopCache1 = new NonStopCache(cache, "non-stop-test-cache");

        CacheManager cacheManager2 = new CacheManager(getClass().getResourceAsStream("/ehcache-decorator-config-test.xml"));
    ...
    public void testMaxThreadPoolSizeProperty() {
        ...
        CacheManager cacheManager1 = new CacheManager(getClass().getResourceAsStream("/ehcache-default-nonstop-decorator-test.xml"));
