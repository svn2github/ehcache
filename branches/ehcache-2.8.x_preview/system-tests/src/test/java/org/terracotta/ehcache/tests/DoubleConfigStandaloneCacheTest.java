 ...
 * @author cdennis
 */
public class DoubleConfigStandaloneCacheTest extends AbstractCacheTestBase {

  public DoubleConfigStandaloneCacheTest(TestConfig testConfig) {
    super("double-config-cache-test.xml", testConfig);
  }
