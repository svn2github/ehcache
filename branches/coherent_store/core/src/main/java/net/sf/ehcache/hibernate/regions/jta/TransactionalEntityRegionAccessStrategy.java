 ...
 */
public class TransactionalEntityRegionAccessStrategy implements EntityRegionAccessStrategy {
     ...
     */
    public TransactionalEntityRegionAccessStrategy(EntityRegion region, Ehcache ehcache, Settings settings) {
        this.region = region;
