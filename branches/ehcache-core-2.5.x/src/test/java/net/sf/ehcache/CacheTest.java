...
public class CacheTest extends AbstractCacheTest {
    ...
    public void testOverflowToDiskAndDiskPersistent() throws Exception {
        CacheManager manager = new CacheManager(new Configuration().name("testOverflowToDiskAndDiskPersistent").diskStore(new DiskStoreConfiguration().path("java.io.tmpdir")));
        try {
