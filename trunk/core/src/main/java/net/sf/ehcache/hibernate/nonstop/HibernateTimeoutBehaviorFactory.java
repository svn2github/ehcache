...
/**
 * A {@link NonstopTimeoutBehaviorFactory} implementation that creates {@link HibernateTimeoutBehavior} instances
 *
 * @author Abhishek Sanoujam
 *
 */
public class HibernateTimeoutBehaviorFactory implements NonstopTimeoutBehaviorFactory {

    /**
     * {@inheritDoc}
     */
    public NonstopStore createNonstopTimeoutBehaviorStore(NonstopActiveDelegateHolder nonstopActiveDelegateHolder) {
        return HibernateTimeoutBehavior.getInstance();
    }
}
