 ...
 */
/**
 * This file incorporates open source from the http://code.google.com/p/concurrentlinkedhashmap/ project
...
import net.sf.ehcache.concurrent.ConcurrentLinkedHashMap.Node.State;
