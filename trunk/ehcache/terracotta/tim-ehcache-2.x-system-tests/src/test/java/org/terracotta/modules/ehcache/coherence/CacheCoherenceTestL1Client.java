...
public class CacheCoherenceTestL1Client {

  private final CyclicBarrier   barrier = new CyclicBarrier(CacheCoherenceTest.CLIENT_COUNT);
  private static final TCLogger logger  = ManagerUtil.getLogger(CacheCoherenceTestL1Client.class.getName());
  private String                id;

  public static void main(String[] args) {
    try {
      new CacheCoherenceTestL1Client().runTest();
    } catch (Throwable e) {
      e.printStackTrace();
