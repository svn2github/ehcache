...
public class L1BMStrongDCV2SerializationWithStatsTest extends TransparentTestBase {
  ...
  public void doSetUp(TransparentTestIface t) throws Exception {
    ...
    cfg.setAttribute(L1BMOnHeapReadWriteTestApp.CONSISTENCY, "STRONG");
    cfg.setAttribute(L1BMOnHeapReadWriteTestApp.STORAGE_STRATEGY, "DCV2");
    cfg.setAttribute(L1BMOnHeapReadWriteTestApp.VALUE_MODE, "serialization");
    cfg.setAttribute(L1BMOnHeapReadWriteTestApp.WITH_STATS, "true");
  }
