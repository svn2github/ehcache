...
public class CacheModelStatsChartPanel extends BaseEhcacheStatsChartPanel implements CacheManagerModelListener,
  ...
  protected ObjectName getBeanName() throws MalformedObjectNameException {
    return EhcacheStatsUtils.getSampledCacheBeanName(cacheManagerModel.getName(), cacheModel.getCacheName());
  }
  ...
  private void setupSummaryPanel() {
    ...
    manageStatsButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
        Component c = CacheModelStatsChartPanel.this;
  ...
  private void handleSummaryText() {
    int statsEnabledCount = cacheManagerModel.getStatisticsEnabledCount(cacheModel);
    int cacheModelInstanceCount = cacheManagerModel.getCacheModelInstanceCount(cacheModel);
    String text = null;
    Icon icon = null;
  ...
  public void cacheModelAdded(final CacheModel cm) {
    /**/
  }

  public void cacheModelRemoved(final CacheModel cm) {
    /**/
  }

  public void cacheModelChanged(final CacheModel cm) {
    /**/
  }
