...
public class ClusteredEventsLocalTest extends TransparentTestBase {
  ...
  public static class App extends AbstractErrorCatchingTransparentApp {
    ...
    protected void runTest() throws Throwable {
      ...
      Cache cache = cacheManager.getCache("testLocal");
      ...
      Assert.assertEquals(ManagerUtil.getClientID(), 1, listener.getPut().size());
      Assert.assertEquals(ManagerUtil.getClientID(), 1, listener.getUpdate().size());
      Assert.assertEquals(ManagerUtil.getClientID(), 1, listener.getRemove().size());
      Assert.assertEquals(ManagerUtil.getClientID(), 1, listener.getRemoveAll());
    }
