...
public class L1BMOnHeapBasicSanityTestApp extends AbstractErrorCatchingTransparentApp {
  public static final int     NODE_COUNT = 2;
  private final CyclicBarrier barrier    = new CyclicBarrier(NODE_COUNT);

  public L1BMOnHeapBasicSanityTestApp(String appId, ApplicationConfig cfg, ListenerProvider listenerProvider) {
  ...
  public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
    config.getOrCreateSpec(L1BMOnHeapBasicSanityTestApp.class.getName()).addRoot("barrier", "barrier").addRoot("nodes", "nodes");
