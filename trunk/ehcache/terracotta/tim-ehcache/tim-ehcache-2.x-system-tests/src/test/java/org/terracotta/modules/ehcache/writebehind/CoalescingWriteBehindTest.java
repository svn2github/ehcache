...
public class CoalescingWriteBehindTest extends TransparentTestBase {
  ...
  public static class App extends AbstractErrorCatchingTransparentApp {
    ...
    protected void runTest() throws Throwable {
      ...
      CacheManager cacheManager = new CacheManager(getClass().getResourceAsStream("/coalescing-writebehind-test.xml"));
      ...
      System.out.println("[Client " + getApplicationId() + " processed " + writer.getWriteCount()
                         + " writes for writer 1]");
      System.out.println("[Client " + getApplicationId() + " processed " + writer.getDeleteCount()
                         + " deletes for writer 1]");
    ...
    public static void visitL1DSOConfig(ConfigVisitor visitor, DSOClientConfigHelper config) {
      config.getOrCreateSpec(App.class.getName()).addRoot("barrier", "barrier")
          .addRoot("totalWriteCount", "totalWriteCount").addRoot("totalDeleteCount", "totalDeleteCount");
