...
public class SynchronousWriteBehindTest extends AbstractStandaloneCacheTest {

  public SynchronousWriteBehindTest() {
    super("synchronous-writebehind-test.xml", WriteBehindClient1.class, WriteBehindClient2.class);
  }

  @Override
  protected Class getApplicationClass() {
    return SynchronousWriteBehindTest.App.class;
  }
