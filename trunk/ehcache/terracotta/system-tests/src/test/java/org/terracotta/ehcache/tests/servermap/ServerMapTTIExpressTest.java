...
public class ServerMapTTIExpressTest extends AbstractExpressCacheTest {

  public ServerMapTTIExpressTest() {
    super("/servermap/basic-servermap-cache-test.xml", ServerMapTTIExpressTestClient.class);
  }
  ...
  protected void setExtraJvmArgs(ArrayList jvmArgs) {
    ...
    jvmArgs.add("-Dcom.tc.ehcache.storageStrategy.dcv2.perElementTTITTL.enabled=true");
    jvmArgs.add("-Dcom.tc.ehcache.storageStrategy.dcv2.evictUnexpiredEntries.enabled=false");
  }
