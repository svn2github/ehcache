...
public class ClusteredEventsLocalTest extends AbstractStandaloneCacheTest {

  public ClusteredEventsLocalTest() {
    super("clustered-events-test.xml", ClusteredEventsLocalClient1.class, ClusteredEventsLocalClient2.class);
    setParallelClients(true);
  }

  @Override
  protected Class getApplicationClass() {
    return ClusteredEventsLocalTest.App.class;
  }
