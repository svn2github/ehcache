...
public class ServerMapElementTTIExpressTest extends AbstractExpressCacheTest {

  public ServerMapElementTTIExpressTest() {
    super("/servermap/basic-servermap-cache-test.xml", ServerMapElementTTIExpressTestClient.class);
  }
