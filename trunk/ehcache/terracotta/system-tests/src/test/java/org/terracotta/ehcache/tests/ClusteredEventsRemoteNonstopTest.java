...
public class ClusteredEventsRemoteNonstopTest extends AbstractStandaloneCacheTest {

  public ClusteredEventsRemoteNonstopTest() {
    super("clustered-events-nonstop-test.xml", ClusteredEventsRemoteClient1.class, ClusteredEventsRemoteClient2.class);
    setParallelClients(true);
  }

  @Override
  protected Class getApplicationClass() {
    return ClusteredEventsRemoteNonstopTest.App.class;
  }
