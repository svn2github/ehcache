...
public class CacheConsistencyTest extends AbstractStandaloneCacheTest {

  public CacheConsistencyTest() {
    super("cache-consistency-test.xml", CacheConsistencyTestClient.class);
  }

  public static class CacheConsistencyTestClient extends ClientBase {

    private CacheConsistencyTestClient(String[] args) {
