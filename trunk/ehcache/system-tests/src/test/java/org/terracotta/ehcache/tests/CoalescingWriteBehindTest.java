...
public class CoalescingWriteBehindTest extends AbstractStandaloneCacheTest {

  public CoalescingWriteBehindTest() {
    super("coalescing-writebehind-test.xml", WriteBehindClient1.class, WriteBehindClient2.class);
  }

  @Override
  protected Class getApplicationClass() {
    return CoalescingWriteBehindTest.App.class;
  }
