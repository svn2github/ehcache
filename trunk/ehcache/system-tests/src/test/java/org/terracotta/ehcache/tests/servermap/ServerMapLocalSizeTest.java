...
public class ServerMapLocalSizeTest extends AbstractExpressCacheTest {

  public ServerMapLocalSizeTest() {
    super("/servermap/basic-servermap-test.xml", ServerMapLocalSizeTestClient.class);
  }

  public static class ServerMapLocalSizeTestClient extends ClientBase {

    private ServerMapLocalSizeTestClient(String[] args) {
