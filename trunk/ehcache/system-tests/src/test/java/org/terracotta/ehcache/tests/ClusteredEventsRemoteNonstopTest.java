...
public class ClusteredEventsRemoteNonstopTest extends AbstractCacheTestBase {

  public ClusteredEventsRemoteNonstopTest(TestConfig testConfig) {
    super("clustered-events-nonstop-test.xml", testConfig, ClusteredEventsRemoteClient1.class,
          ClusteredEventsRemoteClient2.class);
  }
