...
public class ClusteredEventsAllNonstopTest extends AbstractCacheTestBase {

  public ClusteredEventsAllNonstopTest(TestConfig testConfig) {
    super("clustered-events-nonstop-test.xml", testConfig, ClusteredEventsAllClient1.class,
          ClusteredEventsAllClient2.class);
  }
