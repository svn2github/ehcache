...
public class ClusteredEventsAllNonstopTest extends AbstractStandaloneCacheTest {

  public ClusteredEventsAllNonstopTest() {
    super("clustered-events-nonstop-test.xml", ClusteredEventsAllClient1.class, ClusteredEventsAllClient2.class);
    setParallelClients(true);
  }

  @Override
  protected Class getApplicationClass() {
    return ClusteredEventsAllNonstopTest.App.class;
  }
  ...
  public static class App extends AbstractStandaloneCacheTest.App {
    ...
    protected void evaluateClientOutput(String clientName, int exitCode, File clientOutput) throws Throwable {
      ...
      if (!notifedKey1 || !notifedKey2) { throw new AssertionError(clientName); }
    }
  }
}