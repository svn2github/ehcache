...
public class ServerMapCapacityEvictionExpressTest extends AbstractExpressCacheTest {

  public ServerMapCapacityEvictionExpressTest() {
    super("/servermap/basic-servermap-cache-test.xml", ServerMapCapacityEvictionExpressTestClient.class);
  }
