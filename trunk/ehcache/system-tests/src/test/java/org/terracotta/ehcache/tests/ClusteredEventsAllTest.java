...
public class ClusteredEventsAllTest extends AbstractStandaloneCacheTest {

  public ClusteredEventsAllTest() {
    super("clustered-events-test.xml", ClusteredEventsAllClient1.class, ClusteredEventsAllClient2.class);
    setParallelClients(true);
  }

  @Override
  protected Class getApplicationClass() {
    return ClusteredEventsAllTest.App.class;
  }
