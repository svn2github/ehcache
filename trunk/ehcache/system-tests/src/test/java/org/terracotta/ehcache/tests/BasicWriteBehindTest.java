...
public class BasicWriteBehindTest extends AbstractStandaloneCacheTest {

  public BasicWriteBehindTest() {
    super("basic-writebehind-test.xml", WriteBehindClient1.class, WriteBehindClient2.class);
  }

  @Override
  protected Class getApplicationClass() {
    return BasicWriteBehindTest.App.class;
  }
