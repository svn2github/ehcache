 ...
 * 
 *          This class is to be extended to test that we did not forget any rest resources in the Jersey Application
 * 
 */
public class ApplicationEhCacheTestCommon {
  private static final String[] PACKAGE_STARTS_WITH_FILTERS = new String[] { "java", "javax", "org.apache", "com.sun",
    "org.codehaus", "org.hibernate", "org.glassfish.jersey", "com.fasterxml.jackson" };
