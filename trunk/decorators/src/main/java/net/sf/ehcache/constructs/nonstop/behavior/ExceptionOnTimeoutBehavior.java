...
/**
 * Implementation of {@link NonStopCacheBehavior} which throws
 * {@link NonStopCacheException} for all operations.
 * 
...
public class ExceptionOnTimeoutBehavior implements NonStopCacheBehavior {
	...
	public Element get(Object key) throws IllegalStateException, CacheException {
		throw new NonStopCacheException("get for key - '" + key
				+ "'  timed out");
	}
	...
	public Element getQuiet(Object key) throws IllegalStateException,
			CacheException {
		throw new NonStopCacheException("getQuite for key - '" + key
				+ "'  timed out");
	}
	...
	public void put(Element element, boolean doNotNotifyCacheReplicators)
			...
			CacheException {
		throw new NonStopCacheException("put for element - '" + element
	...
	public void putQuiet(Element element) throws IllegalArgumentException,
			IllegalStateException, CacheException {
		throw new NonStopCacheException("putQuiet for element - '" + element
				+ "' timed out");
	...
	public void putWithWriter(Element element) throws IllegalArgumentException,
			IllegalStateException, CacheException {
		throw new NonStopCacheException("putWithWriter for element - '"
				+ element + "' timed out");
	}
	...
	public boolean remove(Object key, boolean doNotNotifyCacheReplicators)
		...
		throw new NonStopCacheException("remove for key - '" + key
				+ "', doNotNotifyCacheReplicators - '"
				+ doNotNotifyCacheReplicators + "' timed out");
	}
	...
	public void removeAll(boolean doNotNotifyCacheReplicators)
		...
		throw new NonStopCacheException(
				"removeAll with doNotNotifyCacheReplicators - '"
						+ doNotNotifyCacheReplicators + "' timed out");
	}
