 ...
 * @author Greg Luck
 */
public class OpenMQJMSCacheManagerPeerProviderFactory extends CacheManagerPeerProviderFactory {
    ...
    private static final Logger LOG = Logger.getLogger(OpenMQJMSCacheManagerPeerProviderFactory.class.getName());
