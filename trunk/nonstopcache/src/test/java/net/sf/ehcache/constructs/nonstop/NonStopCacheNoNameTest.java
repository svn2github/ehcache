...
public class NonStopCacheNoNameTest extends TestCase {
    ...
    private static final String EHCACHE_NONSTOP_NONAME_TEST_XML = "/ehcache-nonstop-noname-test.xml";
    private static final String EHCACHE_NONSTOP_NONAME_FAIL_TEST_XML = "/ehcache-nonstop-noname-fail-test.xml";
