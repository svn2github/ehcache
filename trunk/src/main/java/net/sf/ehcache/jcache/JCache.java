...
public class JCache implements javax.cache.Cache {
    ...
    /**
     * A constructor for JCache that utilised the Ehcache 1.2 Constructor
     * <p/>
    ...
    public JCache(String name,
        ...
        cache = new Cache(name, maxElementsInMemory, memoryStoreEvictionPolicy, overflowToDisk, diskStorePath, eternal,
